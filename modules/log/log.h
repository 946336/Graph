...
#define INFO(logger, msg) logger.log(msg, __FUNCTION__, __FILENAME__, \
        __LINE__, Logger::Level::INFO)
#define DEBUG(logger, msg) logger.log(msg, __FUNCTION__, __FILENAME__, \
        __LINE__, Logger::Level::DEBUG)
#define WARNING(logger, msg) logger.log(msg, __FUNCTION__, __FILENAME__, \
        __LINE__, Logger::Level::WARNING)
#define ERROR(logger, msg) logger.log(msg, __FUNCTION__, __FILENAME__, \
        __LINE__, Logger::Level::ERROR)
#define CRITICAL(logger, msg) logger.log(msg, __FUNCTION__, __FILENAME__,\
